...
@ApplicationScoped
class JakartaAnnotElemSourceParamsBuilder {

    private final StringUtilsPort stringUtils;

    @Inject
    public JakartaAnnotElemSourceParamsBuilder(StringUtilsPort stringUtils) {
        this.stringUtils = stringUtils;
    }

    public List<TargetAnnotParamDto> process(Annotation annotElmt) {
        return JakartaAnnotEnum.getByAnnotType(annotElmt.annotationType())
                .map(jakartaAnnotEnum -> switch (jakartaAnnotEnum) {
